...
with col_cal:
    ...
    # Calendar — uses aria-label*= (contains) selector, works with newlines in labels
    ...
    # CSS using aria-label*= (contains) — matches +£ for profit, -£ for loss
    # This works even when the label has newlines
    st.markdown("""<style>
      ...
      /* Profit days — label contains +£ */
      div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button[aria-label*="+£"] {
        background:linear-gradient(135deg,#d4f5e9,#a8ead0) !important;
        border:1.5px solid #5fcca8 !important;
        color:#0F6E56 !important;
        box-shadow:0 2px 8px rgba(95,204,168,0.30) !important;
      }
      div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button[aria-label*="+£"]:hover {
        transform:translateY(-2px) !important;
        box-shadow:0 5px 14px rgba(95,204,168,0.45) !important;
      }
      /* Loss days — label contains -£ */
      div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button[aria-label*="-£"] {
        background:linear-gradient(135deg,#fde8e4,#f9c4bb) !important;
      ...
      /* Selected profit — primary button type */
      div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button[data-testid="baseButton-primary"][aria-label*="+£"] {
        background:linear-gradient(135deg,#a8ead0,#5fcca8) !important;
        border:1.5px solid #0F6E56 !important;
        color:#0F6E56 !important;
        outline:2.5px solid #0F6E56 !important;
        outline-offset:2px !important;
        box-shadow:0 4px 12px rgba(15,110,86,0.35) !important;
      }
      /* Selected loss — primary button type */
      div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button[data-testid="baseButton-primary"][aria-label*="-£"] {
