                ...
                if dn is None:
                    ...
                    if pnl is not None:
                        ...
                        st.markdown(f"""<div style="
                            background:{bg};border:1.5px solid {brd};border-radius:10px;
                            box-shadow:{shadow};{outline}padding:8px 10px;
                        ...
                        # Real Streamlit button for click detection — styled transparent
